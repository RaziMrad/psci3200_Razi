...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, coltitle=black, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, breakable, colframe=quarto-callout-note-color-frame, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, rightrule=.15mm, arc=.35mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white]
