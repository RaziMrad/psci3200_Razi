...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, opacitybacktitle=0.6, arc=.35mm, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomtitle=1mm, left=2mm, opacityback=0, coltitle=black, breakable]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{FDI_Governance.png}}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{Marginal_Effect.png}
