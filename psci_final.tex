...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, coltitle=black, left=2mm, toprule=.15mm, arc=.35mm, bottomtitle=1mm, breakable, bottomrule=.15mm, colback=white, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, rightrule=.15mm, titlerule=0mm, toptitle=1mm, leftrule=.75mm]
